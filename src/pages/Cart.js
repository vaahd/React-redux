...
function Cart() {
      ...
      {items.length === 0 ? (
        ...
        <>
          <div className="list-group mb-3">
            {items.map((i) => (
              <div key={i.id} className="list-group-item contain">
                <div className="row align-items-center g-2">
                  <div className="col-12 col-sm-3 col-md-2 text-center">
                    <img src={i.image} alt={i.title} className="img-fluid" style={{ maxHeight: "100px", objectFit: "contain" }}/>
                  </div>
                  ...
                  <div className="col-12 col-sm-4 col-md-4 text-center text-sm-end">
                    ...
                    <button className="btn btn-sm btn-danger mt-sm-0" onClick={() => dispatch(removeFromCart(i.id))}>
  ...
  <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5M8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5m3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0"/>
          ...
          <div className="d-flex flex-column flex-sm-row justify-content-between align-items-center">
            ...
            <button className="btn btn-secondary clear" onClick={() => dispatch(clearCart())}>
              Clear Cart
            </button>
          </div>
        </>
